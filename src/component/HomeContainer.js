...
const HomeContainer = ({roomId, socket, listMessage, name, typing, joinedRoom}) => {
    ...
    return <div style={{
        ...
        <ChatContainer>
            <ConversationHeader>
                <Avatar src={img} name="GroupChat"/>
                <ConversationHeader.Content userName="Chat Message" info=" "/>
